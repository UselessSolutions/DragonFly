...
public class DebugBlocks {
	...
	public static final Block testBlock5 = new BlockBuilder(MOD_ID)
		...
		.setTextures(1,3)
		.build(new BlockModel("testblock5", 1004, Material.dirt, ModelHelper.getOrCreateBlockModel(MOD_ID, "block/beacon.json")));
	...
	public static final Block parentModelTest = new BlockBuilder(MOD_ID)
		.setBlockModel(new BlockModelDragonFly(ModelHelper.getOrCreateBlockModel(MOD_ID, "block/black_wool.json")))
		.setTextures(0,0)
		.build(new BlockModel("parentModelTest", 1008, Material.dirt, ModelHelper.getOrCreateBlockModel(MOD_ID, "block/black_wool.json")));
