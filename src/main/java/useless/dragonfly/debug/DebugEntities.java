...
public class DebugEntities {
	public static void init(){
		...
		EntityHelper.createEntity(EntityZombieTest.class, new RenderHTest(ModelHelper.getOrCreateEntityModel(MOD_ID, "zombie_test.json", ZombieModelTest.class), 0.5f), 1000, "zt");
